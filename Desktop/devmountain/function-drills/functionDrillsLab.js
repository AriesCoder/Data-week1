...
let nameGreeting = nameCheck('Trang')
...
//CODE HERE
function printAllNames(namsArr){
  for(let i = 0; i < namesArr.length; i++){
    console.log(namsArr[i])
...
//CODE HERE
function theEliminator(strArr, str){
...
function chocFrogs2(gold){
  let frogChoc = Math.floor(gold / 3)
  console.log(frogChoc)
}

let totalFrogs2 = chocFrogs2(12)
...
function isAscendArr(arr){
 ...
 let arrayIsAscending = isAscendArr(sampleArray)
